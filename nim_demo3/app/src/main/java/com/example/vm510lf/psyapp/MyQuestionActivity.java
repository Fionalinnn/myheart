...
public class MyQuestionActivity extends AppCompatActivity {
    ...
    QuestionAdapter adapter = new QuestionAdapter(myquestionList);
    int index;
    ...
    private void initQuestions() {
        ...
        //查找当前用户所提出的问题
        question.whereEqualTo("student_number",MyLeanCloudApp.usersId);
        //按最后一次更改时间降序排序
        ...
        question.findInBackground(new FindCallback<AVObject>() {
            ...
            public void done(List<AVObject> list, AVException e) {
                for(final AVObject avObject:list){
                    ...
                    myquestionList.add(question_item);
                    index ++;
                    ...
                    query.findInBackground(new FindCallback<AVObject>() {
                        ...
                        public void done(List<AVObject> list, AVException e) {
                            ...
                            myquestionList.get(question_item.getIndex()).setId(avObject.getObjectId());
                            myquestionList.get(question_item.getIndex()).setDetail(content);
