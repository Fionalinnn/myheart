...
import com.example.vm510lf.psyapp.LogInActivity;
import com.example.vm510lf.psyapp.SplashActivity;
import com.example.vm510lf.psyapp.StudentPortActivity;
...
public class MainActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(logNumber==0){
            logNumber=1;
            startActivity(new Intent(MainActivity.this, com.example.vm510lf.psyapp.LogInActivity.class));
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.add_buddy:
                startActivity(new Intent(MainActivity.this, StudentPortActivity.class));
                break;
